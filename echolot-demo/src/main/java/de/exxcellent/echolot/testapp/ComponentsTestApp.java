/*
 * This file (ComponentsTestApp.java) is part of the Echolot Project (hereinafter "Echolot").
 ...
 * here.
 */
public class ComponentsTestApp extends ApplicationInstance {
     ...
     * @see #getActive()
     */
    public static ComponentsTestApp getApp() {
        return (ComponentsTestApp) ApplicationInstance.getActive();
    }
    ...
    public Window init() {
        ...
        mainWindow.setTitle("Echolot Demo Application");
