...
Echo.Sync = { 
    ...
    renderComponentDefaults: function(component, element) {
        ...
        if ((color = component.render("foreground"))) {
            color = Echo.Sync.Color.toInherit(color);
...
Echo.Sync.Color = {
    ...
    /**
     * Converts the color to 'inherit' if necessary
     * 
     * @param {#Color} color to convert
     * @return the converted color
     * @type String
     */
    toInherit: function(color) {
        return (color == -1) ? 'inherit' : color
    }
};
