/*
 * This file (SuggestItemSelectEvent.java) is part of the Echolot Project (hereinafter "Echolot").
...
/**
 * Event for a Selection of a suggestItem
 *
 * @author Ralf Enderle
 * @version 1.0
 */
public class SuggestItemSelectEvent extends EventObject {
    ...
    public SuggestItemSelectEvent(final Object source, final SuggestItem suggestItem) {
        super(source);
