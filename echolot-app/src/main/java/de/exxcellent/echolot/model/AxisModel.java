/*
 * This file (AxisModel.java) is part of the Echolot Project (hereinafter "Echolot").
...
/**
 * Model holding the information of the axis of the lineChart.
 * e.g. the caption of the x- or y-Axis
 *
