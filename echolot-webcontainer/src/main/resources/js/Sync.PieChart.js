                ...
                // on 'mouseover'-callback
                    function () {
                        ...
                        if (style.showPopUp) {
                            ...
                            this.popUp = raphael_self.popup(this.mx, this.my, this.popUpLabel, direction).attr({fill: style.popupBackground, stroke: style.popupBorderColor, "stroke-width": 2, "fill-opacity": .7});
                        }
