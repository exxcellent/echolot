/*
 * This file (MessageDialog.java) is part of the Echolot Project (hereinafter "Echolot").
...
public class MessageDialog extends WindowPane {
    ...
    public MessageDialog(String title, String message, int controlConfiguration) {
        ...
        case CONTROLS_OK:
            setMessageIcon(Styles.ICON_24_MAGNIFIER);
            break;
    ...
    public void setControlConfiguration(int newValue) {
        ...
        switch (controlConfiguration) {
        case CONTROLS_OK:
            button = new Button(resourceBundle.getString("Generic.Ok"), Styles.ICON_24_MAGNIFIER);
            ...
            break;
        case CONTROLS_YES_NO:
            button = new Button(resourceBundle.getString("Generic.Yes"), Styles.ICON_24_MAGNIFIER);
            button.setStyleName("ControlPane.Button");
            button.setActionCommand(COMMAND_OK);
            button.addActionListener(actionProcessor);
            controlsRow.add(button);
            button = new Button(resourceBundle.getString("Generic.No"), Styles.ICON_24_MAGNIFIER);
            button.setStyleName("ControlPane.Button");
