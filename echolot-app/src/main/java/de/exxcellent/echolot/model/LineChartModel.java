/*
 * This file (LineChartModel.java) is part of the Echolot Project (hereinafter "Echolot").
...
/**
 * Model for LineChart holding the points[] displayed on the chart
 * 
 * @author Ralf Enderle <r.enderle@exxcellent.de>
 */
@XStreamAlias("lineChartModel")
