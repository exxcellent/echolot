...
public class FlexiGridTest extends SplitPane {
     ...
     */
    private Object[] createEmailSampleTableModel(boolean includeDataRows) {
		final Column[] columns = new Column[]{
        		new Column(0, "First name", 200, true, "left", false, "The first name of this person."),
                        new Column(1, "Name", 100, true, "right", false),
                        new Column(2, "Email", 300, true, "center", false, "The email address of this person."),
                        new Column(3, "Amount", 50, true, "right", false) };
        final Row[] rows;
        if (includeDataRows) {
            rows =
                    new Row[] { new Row(0, new String[] { "Bob", "Doe", "bob.doe@email.com", "100" }),
                        new Row(1, new String[] { "Bob", "Minelli", "lisa.minelli@email.com", "50" }),
                        new Row(2, new String[] { "Bob", "McDonald", "ronald.mcdonald@email.com", "200" }),
                        new Row(3, new String[] { "Thomas", "Eddison", "thomas@email.com", "400" }),
                        new Row(4, new String[] { "Bruce", "Willis", "bruce@email.com", "320" }),
                        new Row(5, new String[] { "Chuck", "Norris", "chuck@email.com", "8040" }),
                        new Row(6, new String[] { "Hulk", "Hogan", "bob@email.com", "100" }),
                        new Row(7, new String[] { "Bob", "Hump", "bob@email.com", "705" }) };
        } else {
            rows = new Row[0];
        }
        final int rowsCount = rows.length;
        final Page[] pages = new Page[] { new Page(1, rowsCount, rows) };
        return new Object[] { new TableModel(pages), new ColumnModel(columns) };
	}
