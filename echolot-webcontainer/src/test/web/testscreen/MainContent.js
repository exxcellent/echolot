...
exxcellent.test.MainContent = Core.extend(Echo.ContentPane,
    {
        ...
        $construct: function () {
            ...
            // inital overview
            var overviewContent = new exxcellent.test.OverviewContent(this._testArea);
        },

        /** Return the {@link #_componentListColumn}. */
        getComponentListColumn: function () {
            return this._componentListColumn;
        },

        /** Return the {@link #_testArea}. */
        getTestArea: function () {
